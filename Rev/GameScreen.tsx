...
const GameScreen: React.FC<GameScreenProps> = ({ mode, username, roomId, onExit, isHost, session }) => {
    ...
    console.log('ðŸŽ® GameScreen render - Game status:', gameStatus, 'Start time:', gameStartTime, 'Active distractions:', activeDistractions.length);
            ...
            return (
                <div className="space-y-2">
                    <button 
                        ...
                        disabled={isMyReady || !connection || !opponent || !isFaceCentered || !!connectionError}
                    >
