            ...
            <div className="bg-black bg-opacity-50 backdrop-blur-lg border border-gray-700 rounded-2xl p-8 w-full max-w-md shadow-2xl">
                ...
                <div className="mt-8 pt-6 border-t border-gray-700">
                    ...
                    <ul className="text-sm text-gray-300 space-y-2">
                        <li>â€¢ One player creates a room and shares the room ID</li>
                        <li>â€¢ The other player joins using that room ID</li>
                        <li>â€¢ Both players must be ready to start the staring contest</li>
                        <li>â€¢ First player to blink loses!</li>
                    </ul>
                </div>
            </div>
